 ...
 * @author angra
 */
public class telaFatoreal extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(telaFatoreal.class.getName());

    /**
     * Creates new form telaFatoreal
     */
    public telaFatoreal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/fotoFatoreal.png"))); // NOI18N
 ...
 lblFat.setText(Integer.toString(f));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new telaFatoreal().setVisible(true));
    }
